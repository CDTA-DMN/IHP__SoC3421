...
N -780 -600 -730 -600 {
lab=#net3}
N -730 -740 -570 -740 {lab=#net3}
N -780 -500 -730 -500 {
lab=VINP}
N -360 -680 -360 -640 {lab=IB}
N -410 -680 -410 -660 {lab=VSS}
N -730 -620 -480 -620 {lab=#net3}
N -730 -740 -730 -620 {
lab=#net3}
N -410 -500 -410 -470 {lab=VDD}
N -730 -540 -480 -540 {lab=VINP}
N -730 -540 -730 -500 {lab=VINP}
C {devices/title.sym} -980 -20 0 0 {name=l1 author=""}
C {devices/lab_pin.sym} -830 -200 0 0 {name=p5 lab=VCM}
C {devices/lab_pin.sym} -830 -270 0 0 {name=p6 lab=VDD}
C {devices/vsource.sym} -765 -190 1 0 {name=V2 value=0
}
C {devices/code.sym} -370 -320 0 0 {name=LIB_CORNER
only_toplevel=true
value=tcleval("
.csparam TB_ID=$\{::TB_ID\}
...
")}
C {devices/lab_pin.sym} -980 -110 0 0 {name=p12 lab=VCM}
C {devices/lab_pin.sym} -980 -170 0 0 {name=p13 lab=TEMPERATURE}
C {devices/vsource_arith.sym} -980 -140 0 0 {name=E1 VOL=temper}
C {devices/code.sym} -220 -320 0 0 {name=NGSPICE
only_toplevel=true
...
.endc
" }
C {devices/lab_pin.sym} -170 -470 0 0 {name=p3 lab=VCM}
C {devices/lab_pin.sym} -20 -580 0 1 {name=p4 lab=OPOUT}
C {devices/lab_pin.sym} -410 -680 1 0 {name=p8 lab=VSS}
C {devices/isource.sym} -620 -140 0 0 {name=IBIAS value=10e-6}
C {devices/lab_pin.sym} -620 -110 0 0 {name=p14 lab=VCM}
C {devices/capa.sym} -150 -520 0 0 {name=COUT
m=1
value=10f
footprint=1206
device="ceramic capacitor"}
C {devices/vsource.sym} -1040 -440 0 0 {name=VINNDC value=0}
C {devices/lab_pin.sym} -1040 -410 0 0 {name=p2 lab=VCM}
C {devices/vsource.sym} -1040 -540 0 0 {name=VINNAC value="DC 0 AC 0"}
C {devices/lab_pin.sym} -1040 -600 0 0 {name=p16 lab=VINN}
C {devices/lab_pin.sym} -620 -170 0 0 {name=p17 lab=IB}
C {devices/lab_pin.sym} -360 -680 2 0 {name=p18 lab=IB}
C {devices/vsource.sym} -920 -340 0 0 {name=VINPDC value=0}
C {devices/lab_pin.sym} -920 -310 0 0 {name=p1 lab=VCM}
C {devices/vsource.sym} -920 -440 0 0 {name=VINPAC value="DC 0 AC 0"}
C {devices/lab_pin.sym} -920 -500 0 0 {name=p20 lab=VINP}
C {devices/res.sym} -60 -520 2 0 {name=ROUT
value=100G
footprint=1206
device=resistor
m=1}
C {devices/vsource.sym} -830 -240 0 0 {name=VSUPP value="DC 1.65 AC 0"}
C {devices/res.sym} -540 -740 3 0 {name=RFB
value=100G
footprint=1206
device=resistor
m=1}
C {devices/res.sym} -880 -600 3 0 {name=RINN
value=100G
footprint=1206
device=resistor
m=1}
C {devices/res.sym} -780 -550 2 0 {name=RCM
value=100G
footprint=1206
device=resistor
m=1}
C {devices/lab_pin.sym} -830 -110 0 0 {name=p15 lab=VSS}
C {devices/vsource.sym} -830 -140 0 0 {name=VSUPN value="DC 1.65 AC 0"}
C {devices/lab_pin.sym} -735 -190 0 1 {name=p10 lab=0
}
C {devices/vcvs.sym} -110 -700 0 0 {name=E2 value=1}
C {devices/lab_pin.sym} -150 -680 0 0 {name=p9 lab=VSS}
C {devices/lab_pin.sym} -110 -670 0 0 {name=p11 lab=VSS}
C {two_stage_ota_s.sym} -380 -580 2 1 {name=x1}
C {devices/lab_pin.sym} -410 -470 3 0 {name=p7 lab=VDD}
